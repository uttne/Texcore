...
class Score {
    ...
    private _intervalNote: number = 25;
    ...
    public DrawFrame = () => {
        ...
        this._draw.rect(width, height).attr({ fill: '#00f', 'fill-opacity': 0.5, stroke: "#000", 'stroke-width': 2 });//.fill({color:'#00f',opacity:0.5});//.stroke({color:'#00f',width:2,opacity:0.5});
    }
    ...
    private ParseKeyword = (keyword: string): ItemBase => {
        ...
        if (regular.test(keyword)) {
            ...
            switch (pitch.toLowerCase()) {
                case "ces":
                    ret = new NoteItem(Pitch.Ces, octave, length);
                    break;
                case "c":
                    ret = new NoteItem(Pitch.C, octave, length);
                    break;
                case "cis":
                    ret = new NoteItem(Pitch.Cis, octave, length);
                    break;
                case "des":
                    ret = new NoteItem(Pitch.Des, octave, length);
                    break;
                case "d":
                    ret = new NoteItem(Pitch.D, octave, length);
                    break;
                case "dis":
                    ret = new NoteItem(Pitch.Dis, octave, length);
                    break;
                case "es":
                    ret = new NoteItem(Pitch.Es, octave, length);
                    break;
                case "e":
                    ret = new NoteItem(Pitch.E, octave, length);
                    break;
                case "eis":
                    ret = new NoteItem(Pitch.Eis, octave, length);
                    break;
                case "fes":
                    ret = new NoteItem(Pitch.Fes, octave, length);
                    break;
                case "f":
                    ret = new NoteItem(Pitch.F, octave, length);
                    break;
                case "fis":
                    ret = new NoteItem(Pitch.Fis, octave, length);
                    break;
                case "ges":
                    ret = new NoteItem(Pitch.Ges, octave, length);
                    break;
                case "g":
                    ret = new NoteItem(Pitch.G, octave, length);
                    break;
                case "gis":
                    ret = new NoteItem(Pitch.Gis, octave, length);
                    break;
                case "as":
                    ret = new NoteItem(Pitch.As, octave, length);
                    break;
                case "a":
                    ret = new NoteItem(Pitch.A, octave, length);
                    break;
                case "ais":
                    ret = new NoteItem(Pitch.Ais, octave, length);
                    break;
                case "b":
                    ret = new NoteItem(Pitch.B, octave, length);
                    break;
                case "h":
                    ret = new NoteItem(Pitch.H, octave, length);
                    break;
                case "his":
                    ret = new NoteItem(Pitch.His, octave, length);
                    break;
            }
        }
...
class NoteItem extends ItemBase {
    ...
    constructor(pitch: Pitch, octave: number, length: number) {
        super();
